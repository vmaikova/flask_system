...
#
# However, when we do this, we also import `flask_platform/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'flask_platform_cli = flask_platform.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'flask_platform_gui = flask_platform.gui:entry_point'
        # ]
    }
)
